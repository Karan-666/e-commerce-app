...
function ProductItem({product}) {
 ...
 return (
    // We wrap the entire card in a single div to keep it all together.
     <div
      className="bg-white rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300 hover:z-10  bg-gradient-to-br from-blue-200 to-purple-300 border border-slate-700"
    ...
    >
      ...
      <button
        className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 cursor-pointer active:bg-blue-700 transition-all duration-150"
